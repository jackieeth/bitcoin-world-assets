...
export function LandingPage({ onSearch, initialSearchQuery }: LandingPageProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // If the query is a BTC address, we rely on the Gallery component to display the fetched rare sats.
    };
        ...
        <div className="mt-3 landing-page flex min-h-screen flex-col items-center justify-center px-4 text-center">
            <div className="max-w-5xl space-y-8 transition-all duration-500">
                ...
                <p className="mx-auto max-w-[800px] text-m text-white/70 md:text-l">
                    ...
                    <br />
                    <small>
                        Bitcoin World Assets (BWAs) are the foundation of digital worlds as Bitcoin real estates natively born with each block of Bitcoin. BWAs are located on the 1st Satoshi (Uncommon Sats) of the BTC BLOCKS. 100% fair distribution. How many do you cryptographically own?
                    </small>
                </p>
